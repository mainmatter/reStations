...
pub fn insert_station(db: &Connection, record: &StationRecord) -> Result<usize, DbError> {
    Ok(db.execute(
        ...
        rusqlite::params![
            ...
            record.info.de.as_ref().map_or("", |v| v),
            record.info.en.as_ref().map_or("", |v| v),
            record.info.es.as_ref().map_or("", |v| v),
            record.info.fr.as_ref().map_or("", |v| v),
            record.info.it.as_ref().map_or("", |v| v),
            record.info.nb.as_ref().map_or("", |v| v),
            record.info.nl.as_ref().map_or("", |v| v),
            record.info.cs.as_ref().map_or("", |v| v),
            record.info.da.as_ref().map_or("", |v| v),
            record.info.hu.as_ref().map_or("", |v| v),
            record.info.ja.as_ref().map_or("", |v| v),
            record.info.ko.as_ref().map_or("", |v| v),
            record.info.pl.as_ref().map_or("", |v| v),
            record.info.pt.as_ref().map_or("", |v| v),
            record.info.ru.as_ref().map_or("", |v| v),
            record.info.sv.as_ref().map_or("", |v| v),
            record.info.tr.as_ref().map_or("", |v| v),
            record.info.zh.as_ref().map_or("", |v| v),
        ],
    )?)
}
