...
pub fn insert_station(db: &Connection, record: &StationRecord) -> Result<usize, DbError> {
    Ok(db.execute(
        ...
        rusqlite::params![record.name.as_str(),record.slug.as_str(),record.uic.as_str(),record.uic8_sncf.as_str(),record.latitude,record.longitude,record.parent_station_id.as_str(),record.country.as_str(),record.time_zone.as_str(),record.is_city.as_str(),record.is_main_station.as_str(),record.is_airport.as_str(),record.is_suggestable.as_str(),record.country_hint.as_str(),record.main_station_hint.as_str(),record.sncf_id.as_str(),record.sncf_tvs_id.as_str(),record.sncf_is_enabled.as_str(),record.entur_id.as_str(),record.entur_is_enabled.as_str(),record.db_id.as_str(),record.db_is_enabled.as_str(),record.busbud_id.as_str(),record.busbud_is_enabled.as_str(),record.distribusion,record.flixbus_id.as_str(),record.flixbus_is_enabled.as_str(),record.cff_id.as_str(),record.cff_is_enabled.as_str(),record.leoexpress_id.as_str(),record.leoexpress_is_enabled.as_str(),record.obb_id.as_str(),record.obb_is_enabled.as_str(),record.ouigo_id.as_str(),record.ouigo_is_enabled.as_str(),record.trenitalia_id.as_str(),record.trenitalia_is_enabled.as_str(),record.trenitalia_rtvt_id.as_str(),record.trenord_id.as_str(),record.ntv_rtiv_id.as_str(),record.ntv_id.as_str(),record.ntv_is_enabled.as_str(),record.hkx_id.as_str(),record.hkx_is_enabled.as_str(),record.renfe_id.as_str(),record.renfe_is_enabled.as_str(),record.atoc_id.as_str(),record.atoc_is_enabled.as_str(),record.benerail_id.as_str(),record.benerail_is_enabled.as_str(),record.westbahn_id.as_str(),record.westbahn_is_enabled.as_str(),record.sncf_self_service_machine.as_str(),record.same_as.as_str(),record.info.de.as_str(),record.info.en.as_str(),record.info.es.as_str(),record.info.fr.as_str(),record.info.it.as_str(),record.info.nb.as_str(),record.info.nl.as_str(),record.info.cs.as_str(),record.info.da.as_str(),record.info.hu.as_str(),record.info.ja.as_str(),record.info.ko.as_str(),record.info.pl.as_str(),record.info.pt.as_str(),record.info.ru.as_str(),record.info.sv.as_str(),record.info.tr.as_str(),record.info.zh.as_str(),record.normalised_code.as_str(),record.iata_airport_code.as_str()],
    )?)
}
